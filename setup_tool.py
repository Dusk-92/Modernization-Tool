...
class WowSetupTool:
    def __init__(self, root):
        ...
        self.descriptions = {
            ...
            "DiscordPresence.dll": "Shows your WoW character activity on Discord using the built-in OctoWoW Discord application. A read-only helper DLL writes character status under .modernization_tool\\DiscordPresence, while DiscordPresence.exe handles Discord IPC outside the WoW process. Advanced users can override the Application ID with .modernization_tool\\DiscordPresence\\discord_application_id.",
